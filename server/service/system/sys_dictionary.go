...
func (dictionaryService *DictionaryService) GetSysDictionaryInfoList(ctx context.Context, c *app.RequestContext, req request.SysDictionarySearch) (list interface{}, err error) {
