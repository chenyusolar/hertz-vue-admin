...
func (s *SystemApiApi) SyncApi(ctx context.Context, c *app.RequestContext) {
...
func (s *SystemApiApi) GetApiGroups(ctx context.Context, c *app.RequestContext) {
...
func (s *SystemApiApi) IgnoreApi(ctx context.Context, c *app.RequestContext) {
	var ignoreApi system.SysIgnoreApi
	err := c.BindJSON(&ignoreApi)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
...
func (s *SystemApiApi) EnterSyncApi(ctx context.Context, c *app.RequestContext) {
	var syncApi systemRes.SysSyncApis
	err := c.BindJSON(&syncApi)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
