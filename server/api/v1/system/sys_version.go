...
func (sysVersionApi *SysVersionApi) DeleteSysVersion(ctx context.Context, c *app.RequestContext) {
	// 创建业务用Context
	// ctx already provided as parameter
...
func (sysVersionApi *SysVersionApi) DeleteSysVersionByIds(ctx context.Context, c *app.RequestContext) {
	// 创建业务用Context
	ctx = ctx

	IDStr := string(c.Query("IDs[]"))
...
func (sysVersionApi *SysVersionApi) FindSysVersion(ctx context.Context, c *app.RequestContext) {
	// 创建业务用Context
	// ctx already provided as parameter
...
func (sysVersionApi *SysVersionApi) GetSysVersionList(ctx context.Context, c *app.RequestContext) {
	// 创建业务用Context
	// ctx already provided as parameter
...
func (sysVersionApi *SysVersionApi) GetSysVersionPublic(ctx context.Context, c *app.RequestContext) {
	// 创建业务用Context
	// ctx already provided as parameter
...
func (sysVersionApi *SysVersionApi) ExportVersion(ctx context.Context, c *app.RequestContext) {
	// ctx already provided as parameter
...
func (sysVersionApi *SysVersionApi) DownloadVersionJson(ctx context.Context, c *app.RequestContext) {
	// ctx already provided as parameter
...
func (sysVersionApi *SysVersionApi) ImportVersion(ctx context.Context, c *app.RequestContext) {
	// ctx already provided as parameter

	// 获取JSON数据
	var importData systemReq.ImportVersionRequest
	err := c.BindJSON(&importData)
	if err != nil {
