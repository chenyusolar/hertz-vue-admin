...
func (sysParamsApi *SysParamsApi) CreateSysParams(ctx context.Context, c *app.RequestContext) {
	var sysParams system.SysParams
	err := c.BindJSON(&sysParams)
	if err != nil {
...
func (sysParamsApi *SysParamsApi) DeleteSysParams(ctx context.Context, c *app.RequestContext) {
...
func (sysParamsApi *SysParamsApi) DeleteSysParamsByIds(ctx context.Context, c *app.RequestContext) {
...
func (sysParamsApi *SysParamsApi) UpdateSysParams(ctx context.Context, c *app.RequestContext) {
	var sysParams system.SysParams
	err := c.BindJSON(&sysParams)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
...
func (sysParamsApi *SysParamsApi) FindSysParams(ctx context.Context, c *app.RequestContext) {
	ID := string(c.Query("ID"))
...
func (sysParamsApi *SysParamsApi) GetSysParamsList(ctx context.Context, c *app.RequestContext) {
...
func (sysParamsApi *SysParamsApi) GetSysParam(ctx context.Context, c *app.RequestContext) {
	k := string(c.Query("key"))
