...
func (a *AutoCodeTemplateApi) MCP(ctx context.Context, c *app.RequestContext) {
	...
	toolFilePath, err := autoCodeTemplateService.CreateMcp(ctx, info)
	if err != nil {
...
func (a *AutoCodeTemplateApi) MCPList(ctx context.Context, c *app.RequestContext) {
	...
	list, err := testClient.ListTools(ctx, toolsRequest)
...
func (a *AutoCodeTemplateApi) MCPTest(ctx context.Context, c *app.RequestContext) {
	// 定义接口请求结构
	...
	// 绑定JSON请求体
	if err := c.BindJSON(&testRequest); err != nil {
