...
func (sysExportTemplateApi *SysExportTemplateApi) FindSysExportTemplate(ctx context.Context, c *app.RequestContext) {
	...
	if resysExportTemplate, err := sysExportTemplateService.GetSysExportTemplate(sysExportTemplate.ID); err != nil {
		...
		response.OkWithData(map[string]interface{}{"resysExportTemplate": resysExportTemplate}, c)
	}
}
...
func (sysExportTemplateApi *SysExportTemplateApi) ExportExcel(ctx context.Context, c *app.RequestContext) {
	templateID := string(c.Query("templateID"))
	if templateID == "" {
...
func (sysExportTemplateApi *SysExportTemplateApi) ExportExcelByToken(ctx context.Context, c *app.RequestContext) {
...
func (sysExportTemplateApi *SysExportTemplateApi) ExportTemplateByToken(ctx context.Context, c *app.RequestContext) {
	token := string(c.Query("token"))
	if token == "" {
		response.FailWithMessage("导出token不能为空", c)
		return
