...
func (s *DictionaryDetailApi) FindSysDictionaryDetail(ctx context.Context, c *app.RequestContext) {
	...
	response.OkWithDetailed(map[string]interface{}{"reSysDictionaryDetail": reSysDictionaryDetail}, "查询成功", c)
}
...
func (s *DictionaryDetailApi) GetDictionaryTreeList(ctx context.Context, c *app.RequestContext) {
	sysDictionaryID := string(c.Query("sysDictionaryID"))
	if sysDictionaryID == "" {
	...
	response.OkWithDetailed(map[string]interface{}{"list": list}, "获取成功", c)
}
...
func (s *DictionaryDetailApi) GetDictionaryTreeListByType(ctx context.Context, c *app.RequestContext) {
	dictType := string(c.Query("type"))
	if dictType == "" {
...
func (s *DictionaryDetailApi) GetDictionaryDetailsByParent(ctx context.Context, c *app.RequestContext) {
...
func (s *DictionaryDetailApi) GetDictionaryPath(ctx context.Context, c *app.RequestContext) {
	idStr := string(c.Query("id"))
	if idStr == "" {
	...
	response.OkWithDetailed(map[string]interface{}{"path": path}, "获取成功", c)
}
