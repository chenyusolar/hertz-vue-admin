...
func (a *info) CreateInfo(ctx context.Context, c *app.RequestContext) {
	var info model.Info
	err := c.BindJSON(&info)
	if err != nil {
...
func (a *info) DeleteInfo(ctx context.Context, c *app.RequestContext) {
	ID := c.Query("ID")
...
func (a *info) DeleteInfoByIds(ctx context.Context, c *app.RequestContext) {
...
func (a *info) UpdateInfo(ctx context.Context, c *app.RequestContext) {
	var info model.Info
	err := c.BindJSON(&info)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
...
func (a *info) FindInfo(ctx context.Context, c *app.RequestContext) {
	ID := c.Query("ID")
...
func (a *info) GetInfoList(ctx context.Context, c *app.RequestContext) {
...
func (a *info) GetInfoDataSource(ctx context.Context, c *app.RequestContext) {
	// 此接口为获取数据源定义的数据
...
func (a *info) GetInfoPublic(ctx context.Context, c *app.RequestContext) {
	// 此接口不需要鉴权 示例为返回了一个固定的消息接口，一般本接口用于C端服务，需要自己实现业务逻辑
	response.OkWithDetailed(map[string]interface{}{"info": "不需要鉴权的公告接口信息"}, "获取成功", c)
}
